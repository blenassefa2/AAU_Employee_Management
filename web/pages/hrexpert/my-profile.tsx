...
export default function PerformanceEvaluationPage() {
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Performance Evaluation Form</h1>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 max-w-sm">
        <div className="flex flex-col space-y-4">
          ...
          <div className="w-full">
            <label htmlFor="resourceManagement" className="block font-medium">
              Resource Management
            </label>
            <input
              type="number"
          ...
          <div className="w-full">
            ...
            <input
              ...
              id="punctuality"
              className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
              {...register("punctuality", { required: true, min: 0, max: 20 })}
            />
            {errors.punctuality && (
              <span className="text-red-500">
                This field is required and must be between 0 and 20.
          ...
          <div className="w-full">
            ...
            <input
              ...
              {...register("hardworking", { required: true, min: 0, max: 20 })}
            />
            {errors.hardworking && (
              <span className="text-red-500">
                This field is required and must be between 0 and 20.
